...
import {
  APP_INSTALL_NAME,
  formatAppDisplayTitle,
  resolveSettingsVersionLabel,
} from "./appIdentity.js";
...
test("resolveSettingsVersionLabel mirrors the package version without decoration", () => {
  assert.equal(resolveSettingsVersionLabel(" 5.0.0 "), "5.0.0");
  assert.equal(resolveSettingsVersionLabel(""), "");
});
